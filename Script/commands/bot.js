...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "sakib") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "@SAKIB ッ") || (event.body.toLowerCase() == "সাকিব")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ ᏕᏗᏦᎥᏰ ᏰᏂᏗᎥ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/Sakib.bhai.4x/\nতার সাথে যোগাযোগ করবেন Whatsapp :- +8801765051219", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator: ᏕᏗᏦᎥᏰ ᏰᏂᏗᎥ ❤️ হাই আমি মেসেঞ্জার ROBOT  আামার বস সাকিব আমাকে বানিয়েছেন আপনাদেরকে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "shala ami tor boss") || (event.body.toLowerCase() == "shala ami sakib") || (event.body.toLowerCase() == "chup sala ami sakib") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Moni Moni") || (event.body.toLowerCase() == "@Suraiya Islam Mrittika")) {
     return api.sendMessage("খবরদার কেউ এই আইডি মেনশন দিবানা এটা আমার বস সাকিব এর বউ এর আইডি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "mrittika") || (event.body.toLowerCase() == "moni")) {
     return api.sendMessage("খবরদার কেউ এই নাম ধরে ডাক দিবানা এটা আমার বস সাকিব এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "suraiya") || (event.body.toLowerCase() == "মনি")) {
     return api.sendMessage("খবরদার কেউ এই নাম ধরে ডাক দিবানা এটা আমার বস সাকিব এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "সুরাইয়া") || (event.body.toLowerCase() == "মৃত্তিকা")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সাকিব এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "SAKIB KE") || (event.body.toLowerCase() == "sakib ke?")) {
     return api.sendMessage("আমার বস, তার আইডি : https://www.facebook.com/Sakib.bhai.4x/", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_> NOOB ☢️_𖣘 -BOT ⚠️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "koyel") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "cudi") || (event.body.toLowerCase() == "tor nanire xudi")) {
     return api.sendMessage("️তোর তো নুনুই নাই..!🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "gf") || (event.body.toLowerCase() == "bf")) {
     return api.sendMessage("খালি কি তোরাই পেম করবি আমার বস সাকিবকেও একটা গফ দে<🥺", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami SAKIB") || (event.body.toLowerCase() == "kire")) {
